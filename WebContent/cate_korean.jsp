...
<!-- 	banner -->
    ...
    <div class="inner">
       ...
       <div class="kor_top_banner"><img src="./images/kor_banner.jpg"/> </div>
  ...
  <section class="kor_list">
      <div class="bg"></div>
      <div class="inner">
        <div class="kor_kit"><img src="./images/kor_list01.jpg"/></div>
      <div class="go1">
	  ...
	  <div class="go3"> 
	    <span class="material-icons" style="font-size: 30px;"><a href="./detailViewpage/view_soondae.jsp">arrow_forward</a></span>
	  </div>
	    <div class="go4"> 
	    <span class="material-icons" style="font-size: 30px;"><a href="./detailViewpage/view_tteokgalbi.jsp">arrow_forward</a></span>
	  </div>
	  </div>
    </section> 
