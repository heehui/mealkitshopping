...
<body>
  ...
  <section class="ital_list">
	  ...
	  <div class="go3"> 
	    <span class="material-icons" style="font-size: 30px;"><a href="./detailViewpage/view_oilpasta.jsp">arrow_forward</a></span>
	  </div>
	    <div class="go4"> 
	    <span class="material-icons" style="font-size: 30px;"><a href="./detailViewpage/view_risotto.jsp">arrow_forward</a></span>
	  </div>
	  </div>
    </section>
