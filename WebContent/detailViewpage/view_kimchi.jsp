      ...
      <div class="inner">
        ...
        <div class="inner__left">
            <div class="photo_left">
              	<img src="../images/banchan/banchan_kimchi530.jpg" id="pho_detail" class="pho_detail" alt="조선호텔 깍두기">
            </div>
        </div>
          
        <div class="inner__right">
            <div class="detail_right">
            	<span class="sub_name">정성으로 담근 최고의 맛</span><br>
            	<span class="item_name" id="item_name">조선호텔 깍두기 1kg</span><br>
            	<span class="howmuch" id="howmuch">24900원</span>
            </div>
			<br>
			 <!-- 무료배송 알림 -->
            ...
            <div class="optionList">
				...
				function count(type)  {
					  ...
					  if(type === 'plus') {
					    ...
					    number2 = parseInt(number2) + 24900;
					    number3 = parseInt(number3) + 24900;
					  }else if(type === 'minus')  {
					    number1 = parseInt(number1) - 1;
					    number2 = parseInt(number2) - 24900;
					    number3 = parseInt(number3) - 24900;
					...
					<div class="price_box_wrap">
						...
						<div class="price_box">
							<span class="product_price">상품가격</span>
							 <span id="price" class="product_price1 "> 24900</span><span>원</span>
						</div>
						...
						<div class="tot_price">
							...
							<span id="totalPrice" class="tot_price2">24900</span><span>원</span>
						</div>
	...
	<div id="detail-area" class="info_area" style="text-align:center; font-size:36px; font-weight:800px; ">
      <div class="info_area1">
        ...
        <figure class="info_area_image">
          <img src="../images/detailView/detail_kimchi_conf.jpg">
        </figure>   
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
