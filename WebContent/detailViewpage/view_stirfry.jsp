 ...
 <!-- 헤더 -->
  ...
  <!-- 	banner -->
    ...
    <div class="inner">
       ...
       <div class="salad_top_banner"><img src="../images/banchan_banner.jpg"/> </div>
      ...
      <div class="inner">
        ...
        <div class="inner__left">
            <div class="photo_left">
              	<img src="../images/banchan/banchan_stir_fry530.jpg" id="pho_detail" class="pho_detail" alt="꽈리멸치볶음 90g">
            </div>
        </div>
          
        <div class="inner__right">
            <div class="detail_right">
            	<span class="sub_name">은은한 꽈리고추의 향미를 더한</span><br>
            	<span class="item_name" id="item_name">꽈리 멸치 볶음 90g</span><br>
            	<span class="howmuch" id="howmuch">5000원</span>
            </div>
			<br>
			<!-- 무료배송 알림 -->
				...
				<span style="font-size: 12px; color: #555555;">상품페이지 하단참조</span></span>
					...
					<div class="optionList">
						...
						<script>
							function count(type) {
								// 결과를 표시할 element
								var resultElement1 = document
										.getElementById('result');
								var resultElement2 = document
										.getElementById('price');
								var resultElement3 = document
								...
								if (type === 'plus') {
									...
									number2 = parseInt(number2) + 5000;
									number3 = parseInt(number3) + 5000;
								} else if (type === 'minus') {
									number1 = parseInt(number1) - 1;
									number2 = parseInt(number2) - 5000;
									number3 = parseInt(number3) - 5000;
					...
					<div class="price_box_wrap">
						<!-- 상품가격 price box -->
						<div class="price_box">
							<span class="product_price">상품가격</span> <span id="price"
								class="product_price1 "> 5000</span><span>원</span>
						</div>


						<!-- 총 주문금액 -->
						<div class="tot_price">
							<span class="tot_price1">총 주문금액</span> <span id="totalPrice"
								class="tot_price2">5000</span><span>원</span>
						</div>
	...
	<div id="detail-area" class="info_area" style="text-align:center; font-size:36px; font-weight:800px; ">
      <div class="info_area1">
        ...
        <figure class="info_area_image">
          <img src="../images/detailView/detail_stir-fry_conf.jpg">
        </figure>   
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
