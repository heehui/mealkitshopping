      ...
      <div class="inner">
        ...
        <div class="inner__left">
            <div class="photo_left">
              	<img src="../images/kor/kor_tteokgalbi530.jpg" id="pho_detail" class="pho_detail" alt="연탄떡갈비">
            </div>
        </div>
          
        <div class="inner__right">
            <div class="detail_right">
            	<span class="sub_name">육즙이 가득한 살아있는 식감</span><br>
            	<span class="item_name" id="item_name">연탄떡갈비 간장타입</span><br>
	...
	<div id="detail-area" class="info_area" style="text-align:center; font-size:36px; font-weight:800px; ">
      <div class="info_area1">
        ...
        <figure class="info_area_image">
          <img src="../images/detailView/detail_tteokgalbi_conf.jpg">
        </figure>   
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
