      ...
      <div class="inner">
        ...
        <div class="inner__left">
            <div class="photo_left">
              	<img src="../images/banchan/banchan_ojing530.jpg" id="pho_detail" class="pho_detail" alt="오징어볶음 불고기">
            </div>
        </div>
          
        <div class="inner__right">
            <div class="detail_right">
            	<span class="sub_name">매콤한 양념과 부드러운 식감의 만남</span><br>
            	<span class="item_name" id="item_name">오징어 볶음 불고기</span><br>
	...
	<div id="detail-area" class="info_area" style="text-align:center; font-size:36px; font-weight:800px; ">
      <div class="info_area1">
        ...
        <figure class="info_area_image">
          <img src="../images/detailView/detail_ojing_conf.jpg">
        </figure>   
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
