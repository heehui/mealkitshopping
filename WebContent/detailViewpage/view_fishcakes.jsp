 ...
 <!-- 헤더 -->
  ...
  <!-- 	banner -->
    ...
    <div class="inner">
       ...
       <div class="salad_top_banner"><img src="../images/kor_banner.jpg"/> </div>
      ...
      <div class="inner">
        ...
        <div class="inner__left">
            <div class="photo_left">
              	<img src="../images/kor/kor_fish-cakes530.jpg" id="pho_detail" class="pho_detail" alt="모듬 어묵탕 550g">
            </div>
        </div>
          
        <div class="inner__right">
            <div class="detail_right">
            	<span class="sub_name">집에서도 간단하게 조리하는</span><br>
            	<span class="item_name" id="item_name">모듬 어묵탕 550g</span><br>
            	<span class="howmuch" id="howmuch">8900원</span>
            </div>
			<br>
			 <!-- 무료배송 알림 -->
           ...
           <!-- 구매옵션 -->
            <div class="optionList">
				...
				function goCart(){
					...
					//location.href="cart_in.do?p_image='china_tang530.jpg'&p_name='풍미가득 탕수육'&price= 12900";
					})	
			}
					...
					<div class="price_box_wrap">
						...
						<div class="price_box">
							<span class="product_price">상품가격</span>
							 <span id="price" class="product_price1 "> 8900</span><span>원</span>
						</div>
						...
						<div class="tot_price">
							...
							<span id="totalPrice" class="tot_price2">8900</span><span>원</span>
						</div>
	...
	<div id="detail-area" class="info_area" style="text-align:center; font-size:36px; font-weight:800px; ">
      <div class="info_area1">
        ...
        <figure class="info_area_image">
          <img src="../images/detailView/detail_fish-cakes_conf.jpg">
        </figure>   
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
