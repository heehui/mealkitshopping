            ...
            <div class="optionList">
				...
				function count(type)  {
					  ...
					  if(type === 'plus') {
					    ...
					    number2 = parseInt(number2) + 2200;
					    number3 = parseInt(number3) + 2200;
					  }else if(type === 'minus')  {
					    number1 = parseInt(number1) - 1;
					    number2 = parseInt(number2) - 2200;
					    number3 = parseInt(number3) - 2200;
					...
					<div class="price_box_wrap">
						...
						<div class="price_box">
							<span class="product_price">상품가격</span>
							 <span id="price" class="product_price1 "> 2200</span><span>원</span>
						</div>
						...
						<div class="tot_price">
							...
							<span id="totalPrice" class="tot_price2">2200</span><span>원</span>
						</div>
	...
	<div id="detail-area" class="info_area" style="text-align:center; font-size:36px; font-weight:800px; ">
      <div class="info_area1">
        ...
        <figure class="info_area_image">
          <img src="../images/detailView/detail_natto_conf.jpg">
        </figure>   
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
