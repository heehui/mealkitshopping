 ...
 <!-- 헤더 -->
  ...
  <!-- 	banner -->
    ...
    <div class="inner">
       ...
       <div class="salad_top_banner"><img src="../images/salad_banner.jpg"/> </div>
      ...
      <div class="inner">
        ...
        <div class="inner__left">
            <div class="photo_left">
              	<img src="../images/salad/chicken_salad530.jpg" id="pho_detail" class="pho_detail" alt="치킨샐러드">
            </div>
        </div>
          
        <div class="inner__right">
            <div class="detail_right">
            	<span class="sub_name">싱그러운 채소와 부드러운 닭가슴살</span><br>
            	<span class="item_name" id="item_name">치킨샐러드</span><br>
            	<span class="howmuch" id="howmuch">6900원</span>
            </div>
			<br>
			...
			<div class="delivery_tip">
						<span class="delv_tit"><span
							style="font-size: 12px; color: #555555; padding: 0 50px 0 0;">배송비</span></span>
						<span class="delv_cost"><span
							style="font-size: 12px; color: #555555;"><span
								class="delv_price_"><span class="green-color">무료배송</span></span></span></span>
					</div>
					<div class="madein_prod">
						<span class="title"><span>원재료</span></span> <span class="con"><span
							style="font-size: 12px; color: #555555;">상품페이지 하단참조</span></span>
					</div>
					...
					<div class="price_box_wrap">
						...
						<div class="price_box">
							<span class="product_price">상품가격</span>
							 <span id="price" class="product_price1 "> 6900</span><span>원</span>
						</div>
						...
						<div class="tot_price">
							...
							<span id="totalPrice" class="tot_price2">6900</span><span>원</span>
						</div>

						<!-- 장바구니/바로구매 버튼 -->
						<div class="cart_pur" style="margin: 40px;">

							<button type="button" class="cart_btn" onclick="goCart(); return false;">장바구니</button>
	...
	<div id="detail-area" class="info_area" style="text-align:center; font-size:36px; font-weight:800px; ">
      <div class="info_area1">
        ...
        <figure class="info_area_image">
          <img src="../images/detailView/detail_chickensalad_conf.jpg">
        </figure>   
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
