      ...
      <div class="inner">
        ...
        <div class="inner__left">
            <div class="photo_left">
              	<img src="../images/italian/italian_risotto530.jpg" id="pho_detail" class="pho_detail" alt="트러플 오색리조또">
            </div>
        </div>
          
        <div class="inner__right">
            <div class="detail_right">
            	<span class="sub_name">세계 3대 진미 트러플 </span><br>
            	<span class="item_name" id="item_name">오일파스타 밀키트</span><br>
            	<span class="howmuch" id="howmuch">11900원</span>
            </div>
			<br>
			<!-- 무료배송 알림 -->
            ...
            <div class="optionList">
				...
				function count(type)  {
					  ...
					  if(type === 'plus') {
					    ...
					    number2 = parseInt(number2) + 11900;
					    number3 = parseInt(number3) + 11900;
					  }else if(type === 'minus')  {
					    number1 = parseInt(number1) - 1;
					    number2 = parseInt(number2) - 11900;
					    number3 = parseInt(number3) - 11900;
					...
					<div class="price_box_wrap">
						...
						<div class="price_box">
							<span class="product_price">상품가격</span>
							 <span id="price" class="product_price1 "> 11900</span><span>원</span>
						</div>
						...
						<div class="tot_price">
							...
							<span id="totalPrice" class="tot_price2">11900</span><span>원</span>
						</div>
	...
	<div id="detail-area" class="info_area" style="text-align:center; font-size:36px; font-weight:800px; ">
      <div class="info_area1">
        ...
        <figure class="info_area_image">
          <img src="../images/detailView/detail_risotto_conf.jpg">
        </figure>   
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
