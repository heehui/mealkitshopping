  ...
  <jsp:include page ="../header2.jsp" flush="true"/>
	...
	<section class="banner">
		...
		<div class="inner">
			...
			<div class="salad_top_banner">
				<img src="../images/kor_banner.jpg" />
			</div>
			...
			<div class="inner">
				...
				<div class="inner__left">
					<div class="photo_left">
						<img src="../images/kor/kor_bibimbab530.jpg" id="pho_detail" class="pho_detail"
							alt="테이스티비빔밥세트">
					</div>
				</div>
					...
					<div class="price_box_wrap">
						...
						<div class="price_box">
							<span class="product_price">상품가격</span>
							 <span id="price" class="product_price1 "> 13000</span><span>원</span>
						</div>
						...
						<div class="tot_price">
							...
							<span id="totalPrice" class="tot_price2">13000</span><span>원</span>
						</div>
	...
	<div id="detail-area" class="info_area"	style="text-align: center; font-size: 36px; font-weight: 800px;">
		<div class="info_area1">
			...
			<figure class="info_area_image">
				<img src="../images/detailView/detail_bibimbab_conf.jpg">
			</figure>
			<p>&nbsp;</p>
			<p>&nbsp;</p>
			<p>&nbsp;</p>
