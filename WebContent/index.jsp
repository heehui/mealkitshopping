...
<body>
  ...
  <section class="notice">
    ...
    <!--PROMOTION-->    <!-- BEST 상품 스와이퍼로 보여주기 (5개, 가운데만 투명, 사이드 불투명하게 하기, 화살표로 넘기기,  -->
    <div class="promotion">
      ...
      <div class="swiper-container">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            ...
            <a href="./detailViewpage/view_pizza.jsp" class="btn">자세히 보기</a>
          </div>
          <div class="swiper-slide">
            <img src="./images/tomato_pasta_b.jpg" alt="토마토스파게티" />
            <a href="./detailViewpage/view_tomatopasta.jsp" class="btn">자세히 보기</a>
          </div>
          <div class="swiper-slide">
            <img src="./images/china_tang_b.jpg" alt="탕수육" />
            <a href="./detailViewpage/view_tang.jsp" class="btn">자세히 보기</a>
          </div>
          <div class="swiper-slide">
            <img src="./images/kor_bibimbab_b.jpg" alt="비빔밥" />
            <a href="./detailViewpage/view_bibimbab.jsp" class="btn">자세히 보기</a>
          </div>
          <div class="swiper-slide">
            <img src="./images/kor_fish-cakes_b.jpg" alt="어묵탕" />
            <a href="./detailViewpage/view_fishcakes.jsp" class="btn">자세히 보기</a>
          </div>
        </div>
      </div>
  ...
  <section class="special_kit">
    <div class="bg"></div>
    <div class="inner">
      <div class="special__pic"><img src="./images/special.jpg"/> </div>
  ...
  <section class="login_join_sub">
    ...
    <div class="inner">
      ...
      <div class="btn-group">
        <a href="./join.jsp" class="btn btn--reverse">회원가입</a>
        <a href="./login.jsp" class="btn btn--reverse">로그인</a>
      </div>
